...
**Trigger:** `trigger_sincronizar_stock` → AFTER INSERT, actualiza `productos.cantidad_gramos`
...
|---|---|---|---|
| `trigger_sincronizar_stock` | inventario_movimientos | AFTER INSERT | `sincronizar_stock()` → actualiza productos.cantidad_gramos |
