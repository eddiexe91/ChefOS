...
- Migraciones `001_schema_base.sql` a `006_consistencia_operativa.sql`: aplicadas remotamente y verificadas.
- Tablas principales y cuatro buckets de Storage verificados; existe al menos un usuario/restaurante de prueba creado durante la validación.
